...
class Node {
    ...
    #data:Array<any> = [] //The initial data array as a private field so can't be manipulated outside of class methods

    constructor(parent?: Node, value?:any, child?: Node){
...
const myList:LinkedList = new LinkedList()
